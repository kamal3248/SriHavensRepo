...
<link
	...
	rel="stylesheet">
<script src="./Scripts/bills.js?<%=dynKey%>"></script>
</head>
<body>
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-5">
							<h2>
								<i class="fa-solid fa-file-invoice"></i> <b>Bills</b>
							</h2>
						</div>
						<div class="col-sm-7">
							<button class="btn btn-secondary"
								data-type="open_create_bill_modal">
								<i class="fa fa-circle-plus"></i> <span>New Bill</span>
							</button>
				...
				<table id="bills-overview"
					...
					<tbody id="u_ovr_tbl_body">
						<tr>
							<td colspan="8" class="txt-center-align danger bold">No
	...
	<jsp:include page="/WEB-INF/Views/BillCreation.jsp"></jsp:include>
<%-- 	<jsp:include page="/WEB-INF/Views/BillEdit.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/BillDelete.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/BillView.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/BillDelivery.jsp"></jsp:include> --%>
</body>
<script
