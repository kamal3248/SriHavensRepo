...
<title>Frame Master Data Administration</title>
<%
...
<link
	...
	rel="stylesheet">
<script src="./Scripts/framemaster.js?<%=dynKey%>"></script>
</head>
<body>
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-5">
							<h2>
								<i class="fa fa-clone"></i> Frame <b>Master Data</b>
							</h2>
						</div>
						<div class="col-sm-7">
							<button class="btn btn-secondary"
								data-type="open_create_frame_master_record_modal">
								<i class="fa fa-circle-plus"></i> <span>New Frame Master
									Record</span>
							</button>
				...
				<table id="frame-master-overview"
	...
	<jsp:include page="/WEB-INF/Views/FrameMasterCreation.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/FrameMasterEdit.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/FrameMasterDelete.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/FrameMasterView.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/Views/FrameMasterRecreate.jsp"></jsp:include>
</body>
<script
