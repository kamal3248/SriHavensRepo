...
public class RandomStringGenerator {
    ...
    public RandomStringGenerator(int length, boolean isSpecialChar,boolean additional) {
        this(length, new SecureRandom(), isSpecialChar ? ALPHA_NUM+SPECIAL : ALPHA_NUM);
    }
